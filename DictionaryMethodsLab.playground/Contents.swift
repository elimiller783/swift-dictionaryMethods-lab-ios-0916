...
if starWarsCharacters.isEmpty {
    print("there are \(starWarsCharacters.count)")
}

print("Nothing is printed to console since the dictionary isnt empty")
...
if starWarsCharacters.keys.contains("Bounty Hunters") {
